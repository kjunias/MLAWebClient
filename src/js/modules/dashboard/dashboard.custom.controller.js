/**=========================================================
 * Module: CustomDashboardController.js
 =========================================================*/
...
(function() {
    ...
    CustomDashboardController.$inject = ['$rootScope', '$scope', '$http', '$modal', '$controller', 'colors', 'flotOptions', '$timeout', 'serverStatus', 'memoryleaks', 'BACKEND', 'VERSION'];
    function CustomDashboardController($rootScope, $scope, $http, $modal, $controller, colors, flotOptions, $timeout, serverStatus, memoryleaks, BACKEND, VERSION) {
      var vm = this;
